    ...
    salvarVaga() {
      ...
      if (this.validaFormulario()) {
        ...
        this.emitter.emit("alerta", {
          ...
          descricao:
            "Parabens, a vaga foi cadastrada e poderá sert consultada por milhares de profissionais em nossa plataforma",
        });
        ...
        this.emitter.emit("alerta", {
          ...
          descricao:
            "Parece que vocês esqueceu de preencher alguma informação. Faça o ajuste e tente novamente. Obrigado",
        });
      }
    },
